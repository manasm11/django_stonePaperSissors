...
function setBoxColor(choice) {
    if (isComputerSrc(srcOf(choice)))
        setChoiceShadowColor(choice, 'blue')
    else
        switch (srcOf(choice)) {
            case stone_url:
                isComputerSrc(paper_url) ? setChoiceShadowColor(choice, 'red') : setChoiceShadowColor(choice, 'greenyellow')
                break;
            case paper_url:
                isComputerSrc(scissor_url) ? setChoiceShadowColor(choice, 'red') : setChoiceShadowColor(choice, 'greenyellow')
                break;
            default: {
                isComputerSrc(stone_url) ? setChoiceShadowColor(choice, 'red') : setChoiceShadowColor(choice, 'greenyellow')
                break;
            }
        }
}
